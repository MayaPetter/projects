 ...
 * Return: return SUCCESS for success, none-zero otherwise
 * Errors: if memory allocation failed, returns FAIL
 */
 ...
 * Return: return SUCCESS for success, none-zero otherwise
 * Errors: if pointer is NULL, behaviour is undefined 
 *		   if queue is empty, returns FAIL
 */
 ...
 * Errors: if queue is empty, returns NULL
 */
 ...
 * Param queue : pointer to queue
 * Return: size of queue. If queue empty, returns 0
 */
