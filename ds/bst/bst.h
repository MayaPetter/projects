...
/*
 * Insert new element to tree, based on BST cmp_func 
 * Param @bst - pointer to binary search tree  
 * Param @data - pointer to data to insert
 * Return : iter to new leaf
 * Note : position of duplicated values can be before or after each other. 
 * Errors : if failed, return BSTEnd
 */
...
/*** helper functions for user tree summary**/
