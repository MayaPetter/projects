...
/*
 * Create a buffer. Time complexity O(1), space O(n).
...
/*
 * Destroy the buffer. Time complexity O(1).
 * Param circ_buff: pointer to the buffer.
 */
void CircBuffDestroy(circ_buff_t *circ_buff);

/*
 * Write to the buffer. Time complexity O(n), space O(n).
...
/*
 * Read from the buffer. Time complexity O(n), space O(n).
...
/*
 * Check if buffer is empty. Time complexity O(1), space O(n).
 * Param circ_buff: pointer to the buffer.
...
/*
 * Get buffer maximum capacity. Time complexity O(1).
 * Param circ_buff: pointer to the buffer.
...
/*
 * Get current size of free space of the buffer. Time complexity O(1).
 * Param circ_buff: pointer to the buffer.
