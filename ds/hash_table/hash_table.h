 ...
 * Errors: if allocation is failed, returns non-zero value.
 */
 ...
 * Return: if data not found, NULL is returned, else pointer to the found data.
 */
 ...
 * Param @hash_table: pointer to the hash table.
 * Param @act_func: function to preform.
 * Return: on success, 0 is returned.
