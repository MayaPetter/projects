...
/*
 * Counts off (0) bits in bit array, must be implemented with a lookup table
 * Param bit_array: the bit array
 * Returns: number of off bits
 * Errors: none
*/
...
/*
 * reverses the order of the bits, must be implemented with a lookup table
 * Param bit_array: the bit array
 * Returns: mirrored bit_array (end to start)
 * Errors: none
 */
